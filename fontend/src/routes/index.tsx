...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "OMKARA — Bhatia Attachi House | Bags, Luggage & Repairs" },
      { name: "description", content: "Wholesale & retail bag store with expert repair services. School bags, trolleys, purses, office bags, raincoats and more." },
      { property: "og:title", content: "OMKARA — Bhatia Attachi House" },
      { property: "og:description", content: "Bags, luggage and professional repairs under one roof." },
      ...
      <div className="container-page grid lg:grid-cols-2 gap-14 items-center">
        <div>
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <Link to="/repairs" className="btn-primary">Repair Services <ArrowRight className="size-4" /></Link>
    ...
    <section className="section-pad bg-[var(--cream)]">
      <div className="container-page">
        ...
        <div className="mt-8 text-center">
          <Link to="/gallery" className="btn-outline !text-foreground !border-foreground/30 hover:!bg-foreground/5">View Full Gallery <ArrowRight className="size-4" /></Link>
        </div>
      </div>
    </section>
  );
